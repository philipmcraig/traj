...
trajfiles = trajfiles[[20,360]]; initfiles = initfiles[[20,360]]
...
#jan1st = 0.
#feb1st = pl.where(trajfiles=='utraj-df_eaa'+year+'020100')[0][0]
#mar1st = pl.where(trajfiles=='utraj-df_eaa'+year+'030100')[0][0]
#apr1st = pl.where(trajfiles=='utraj-df_eaa'+year+'040100')[0][0]
#may1st = pl.where(trajfiles=='utraj-df_eaa'+year+'050100')[0][0]
#jun1st = pl.where(trajfiles=='utraj-df_eaa'+year+'060100')[0][0]
#jul1st = pl.where(trajfiles=='utraj-df_eaa'+year+'070100')[0][0]
#aug1st = pl.where(trajfiles=='utraj-df_eaa'+year+'080100')[0][0]
#sep1st = pl.where(trajfiles=='utraj-df_eaa'+year+'090100')[0][0]
#oct1st = pl.where(trajfiles=='utraj-df_eaa'+year+'100100')[0][0]
#nov1st = pl.where(trajfiles=='utraj-df_eaa'+year+'110100')[0][0]
#dec1st = pl.where(trajfiles=='utraj-df_eaa'+year+'120100')[0][0]
...
#
#ind_prf_jan = pl.mean(indflx2[jan1st:feb1st],axis=0)
#ind_prf_feb = pl.mean(indflx2[feb1st:mar1st],axis=0)
#ind_prf_mar = pl.mean(indflx2[mar1st:apr1st],axis=0)
#ind_prf_apr = pl.mean(indflx2[apr1st:may1st],axis=0)
#ind_prf_may = pl.mean(indflx2[may1st:jun1st],axis=0)
#ind_prf_jun = pl.mean(indflx2[jun1st:jul1st],axis=0)
#ind_prf_jul = pl.mean(indflx2[jul1st:aug1st],axis=0)
#ind_prf_aug = pl.mean(indflx2[aug1st:sep1st],axis=0)
#ind_prf_sep = pl.mean(indflx2[sep1st:oct1st],axis=0)
#ind_prf_oct = pl.mean(indflx2[oct1st:nov1st],axis=0)
#ind_prf_nov = pl.mean(indflx2[nov1st:dec1st],axis=0)
#ind_prf_dec = pl.mean(indflx2[dec1st:],axis=0)
#
#ind_prf_months = pl.array([ind_prf_jan,ind_prf_feb,ind_prf_mar,ind_prf_apr,
#                           ind_prf_may,ind_prf_jun,ind_prf_jul,ind_prf_aug,
#                           ind_prf_sep,ind_prf_oct,ind_prf_nov,ind_prf_dec])
#f = open('/home/np838619/Trajectory/fluxpart/'+year+'/'+shed+'/monthprofs_ind.csv','w')
#pl.savetxt(f,ind_prf_months); f.close()
#
#
#pac_prf_jan = pl.mean(pacflx2[jan1st:feb1st],axis=0)
#pac_prf_feb = pl.mean(pacflx2[feb1st:mar1st],axis=0)
#pac_prf_mar = pl.mean(pacflx2[mar1st:apr1st],axis=0)
#pac_prf_apr = pl.mean(pacflx2[apr1st:may1st],axis=0)
#pac_prf_may = pl.mean(pacflx2[may1st:jun1st],axis=0)
#pac_prf_jun = pl.mean(pacflx2[jun1st:jul1st],axis=0)
#pac_prf_jul = pl.mean(pacflx2[jul1st:aug1st],axis=0)
#pac_prf_aug = pl.mean(pacflx2[aug1st:sep1st],axis=0)
#pac_prf_sep = pl.mean(pacflx2[sep1st:oct1st],axis=0)
#pac_prf_oct = pl.mean(pacflx2[oct1st:nov1st],axis=0)
#pac_prf_nov = pl.mean(pacflx2[nov1st:dec1st],axis=0)
#pac_prf_dec = pl.mean(pacflx2[dec1st:],axis=0)
#
#pac_prf_months = pl.array([pac_prf_jan,pac_prf_feb,pac_prf_mar,pac_prf_apr,
#                           pac_prf_may,pac_prf_jun,pac_prf_jul,pac_prf_aug,
#                           pac_prf_sep,pac_prf_oct,pac_prf_nov,pac_prf_dec])
#f = open('/home/np838619/Trajectory/fluxpart/'+year+'/'+shed+'/monthprofs_pac.csv','w')
#pl.savetxt(f,ind_prf_months); f.close()
